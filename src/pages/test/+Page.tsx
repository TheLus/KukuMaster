    ...
    <Grid container direction='column' sx={sx}>
      ...
      <Grid container className='TopPage' justifyContent='center'>
        <Grid container className='Scroller' justifyContent='center' style={{ transform: isTestMode ? 'translateY(-100dvh)' : 'none' }}>
          <Grid container direction='column' alignItems='center' width='100%' gap={2} pt={8} sx={{ overflowY: 'scroll', height: '100dvh' }} wrap='nowrap' pb={4}>
            ...
            <Typography variant='h5' mt={2}>九九せんせいの試練</Typography>
            <Grid container gap={1}>
            ...
            <Typography variant='h5' mt={2}>九九たつじんの試練</Typography>
            <Grid container gap={1}>
            ...
            <Typography variant='h5' mt={2}>九九マスターの試練</Typography>
            <Grid container gap={1}>
